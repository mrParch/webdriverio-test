...
const jsonTmpDirectory = `test/reports/json/tmp/`;
...
exports.config = {
    ...
    baseUrl: 'https://todo.microsoft.com/tasks/',
    //
    ...
    cucumberOpts: {
        require: ['./test/helpers/common.js', './test/step_definitions/*.js', './test/support/*.js'],        // <string[]> (file/dir) require files before executing features
